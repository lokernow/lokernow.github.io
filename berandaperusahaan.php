...
<html lang="en">
  <head>
    <title>LokerNow | Beranda Perusahaan</title>
    <meta charset="utf-8">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-9">
            <p style="margin: 0;font-size: 24px; font-weight: bold; color: white"><?php echo htmlspecialchars($companyProfile['nama_perusahaan'] ?? 'Nama Perusahaan'); ?></p>
            <p style="color:white;"><?php echo htmlspecialchars($companyProfile['deskripsi'] ?? 'Deskripsi perusahaan belum ditambahkan'); ?></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              ...
              <div class="job-listing-meta">
                <span class="badge badge-<?php echo $job['tipe_pekerjaan'] == 'Full Time' ? 'success' : 'danger'; ?>">
        ...
        <div class="row pagination-wrap">
          <div class="col-md-6 text-center text-md-left mb-4 mb-md-0">
            <span>Menampilkan <?php echo min(7, $totalJobs); ?> dari <?php echo $totalJobs; ?> Lowongan</span>
          </div>
